...
import { View } from '../Mobile/style.js';
class HTML extends Component {
  ...
  componentDidMount(){
    axios.get('js/data.json').then( res=> { this.setState({images:res.data.HTML}) })
  }
  handleclick=(image)=>{
    this.setState({
      Photo:image
  ...
  return (
        <PortfolioSection>
            ...
            <PortfolioList>
                ...
                <PortfolioItem active><NavLinkItems className="selected" to="/HTML">HTML</NavLinkItems></PortfolioItem>
