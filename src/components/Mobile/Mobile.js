...
import {NavLinkItems,Box,Span,Img,Overlay,OverlayButton,PortfolioSection,PortfolioItem,PortfolioList,PortfolioTitle} from './style.js';
import { View } from '../Photoshop/style.js';
class Mobile extends Component {
  ...
  componentDidMount(){
    axios.get('js/data.json').then( res=> { this.setState({images:res.data.Mobile}) })
  }
  ...
  return (
        <PortfolioSection>
            ...
            <PortfolioList>
                ...
                <PortfolioItem active><NavLinkItems className="selected" to="/Mobile">Mobile</NavLinkItems></PortfolioItem>
            </PortfolioList> 
            <View>
