...
class Wordpress extends Component {
  ...
  componentDidMount(){
    axios.get('js/data.json').then( res=> { this.setState({images:res.data.Wordpress}) })
  }
  handleclick=(image)=>{
    this.setState({
      Photo:image
  ...
  return (
        <PortfolioSection>
            ...
            <PortfolioList>
                ...
                <PortfolioItem active><NavLinkItems className="selected" to="/Wordpress">Wordpress</NavLinkItems></PortfolioItem>
